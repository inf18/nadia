 ...
 * laporantiket.java
 *
 * Created on May 21, 2017, 4:54:57 PM
 */
package tiketkonser;
...
public class laporantiket extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(TxtNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 1030, 0, 0));
  ...
  try{
       ...
       // Menampilkan ke JTable  melalui tabModel
        ...
        while(rs.next()){
         ...
         Object Data[]={Kelas,Jenis,Harga,Stok};
    ...
    String [] JudulKolom={"kelas","jenis_tiket","harga","stok"};
    ...
    try {
        ...
        File report = new  File("src/laporan/laporantiket.jrxml");
